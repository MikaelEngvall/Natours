    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          stripe = Stripe('pk_test_51MYkVQIsMsAGEtsptKTeoYCnHrBYLRw0R17Eh1ccTUHPY8l4NzhWRJyIC9oQWMe0IFF0juuhtyv44OfyZlnPwQ0b00ylKvQGIF');
          _context.prev = 1;
          _context.next = 4;
  ...
  deleteButtons.forEach(function (button) {
    button.addEventListener('click', /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
        var userId, confirmation, response;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.prev = 3;
              _context2.next = 6;
              return fetch("/delete-user/".concat(userId), {
                method: 'PATCH',
                headers: {
                  'Content-Type': 'application/json'
                },
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var toggleButton = document.querySelector('.sidebar__toggle');
  var icon = toggleButton.querySelector('use');
  toggleButton.addEventListener('click', function () {
    ...
    icon.setAttribute('xlink:href', "img/icons.svg#icon-".concat(isExpanded ? 'close' : 'menu'));
  });
});
